...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	[[UIApplication sharedApplication] openURL:[NSURL URLWithString:number2]];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	NSString *chatId = [Chat chatId:recipientId];
	//---------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	ChatView *chatView = [[ChatView alloc] initWith:dbuser.objectId];
