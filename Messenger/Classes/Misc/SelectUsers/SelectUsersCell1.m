...
@implementation SelectUsersCell1
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	if (path == nil)
	{
		imageUser.image = [UIImage imageNamed:@"selectusers_blank"];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[DownloadManager image:dbuser.picture completion:^(NSString *path, NSError *error, BOOL network)
	{
		...
		{
			SelectUsersCell1 *cell = [tableView cellForRowAtIndexPath:indexPath];
