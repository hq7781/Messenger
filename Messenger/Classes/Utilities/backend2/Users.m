...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	//---------------------------------------------------------------------------------------------------------------------------------------------
	firebase = [[[FIRDatabase database] referenceWithPath:FLINKEDUSER_PATH] child:[FUser currentId]];
	...
	[query observeEventType:FIRDataEventTypeChildAdded withBlock:^(FIRDataSnapshot *snapshot)
	{
		...
		if ((user[FUSER_CREATEDAT] != nil) && (user[FUSER_FULLNAME] != nil))
		{
	...
	{
		NSDictionary *user = snapshot.value;
		if ((user[FUSER_CREATEDAT] != nil) && (user[FUSER_FULLNAME] != nil) && ([FUser currentId] != nil))
		{
			dispatch_async(dispatch_queue_create(nil, DISPATCH_QUEUE_SERIAL), ^{
				[self updateRealm:user];
				refreshUserInterface = YES;
